...
app.put('/api/recipes/:id',(req,res)=>{
    ...
    updatePlayer(res,req.params.id, req.params.name, req.params.age, req.params.hometown, req.params.former, req.params.current, req.params.years);
});

async function updatePlayer(res,id,name,age,hometown,years,former,current,years){
